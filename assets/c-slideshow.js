import EmblaCarousel from "//moonrockgems.com/cdn/shop/t/13/assets/m-carousel.js?v=7956072137199587391761140176"
import ClassNames from "//moonrockgems.com/cdn/shop/t/13/assets/h-carousel-cn.js?v=74413230910519084281761140169"
    ...
    customElements.define('coretex-slideshow', class CoretexSlideshow extends HTMLElement {
        ...
        async connectedCallback() {
            ...
            if (this.hasAttribute('autoplay')) {
                ...
                const { default: Autoplay } = await import("//moonrockgems.com/cdn/shop/t/13/assets/h-carousel-ap.js?v=151989844542395062071761140167"); // conditionally load plugin w/ dynamic imports
            ...
            if (this.hasAttribute('auto-height')) {
                const { default: AutoHeight } = await import("//moonrockgems.com/cdn/shop/t/13/assets/h-carousel-ah.js?v=44275636832617084041761140166"); // conditionally load plugin w/ dynamic imports
                plugins.push(AutoHeight({destroyHeight: 'auto'}));
            }

            // Check for slider-fade attribute
            if (this.hasAttribute('fade')) {
                const { default: Fade } = await import("//moonrockgems.com/cdn/shop/t/13/assets/h-carousel-fa.js?v=36576538050214963121761140170"); // conditionally load plugin w/ dynamic imports
                plugins.push(Fade());
            }
